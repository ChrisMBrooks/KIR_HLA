...
filename = 'Analysis/ElasticNet/en_results_candidate_phenos_{}.txt'.format(date_str)
...
filename = 'Analysis/ElasticNet/grid_search_results_{}.csv'.format(data_sci_mgr.data_mgr.get_date_str())
