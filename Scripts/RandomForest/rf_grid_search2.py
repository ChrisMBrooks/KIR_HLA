...
hyper_params_grid['max_depth'] = [20]
hyper_params_grid['n_estimators'] = [300]
hyper_params_grid['max_features'] = [0.1]
hyper_params_grid['max_samples'] = [0.4]
hyper_params_grid['min_samples_split'] = [10]
