...
class NeuralNet(t.nn.Module):
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.fc2 = t.nn.Linear(hidden_size, hidden_size, bias=False)
...
nnr = SimpleNeuralNetRegressor(epochs = 1000, batch_size = 128, learning_rate=0.01)
...
print(epoch_losses[0], epoch_losses[-1])